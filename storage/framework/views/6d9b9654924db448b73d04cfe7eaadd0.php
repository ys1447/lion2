...
<?php endif; ?>
<?php $component->withAttributes(['model' => 'search','placeholder' => 'Search Batch, Job, Machine, Notes (TRIAL RND)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <table class="w-full min-w-max table-auto border-separate border-spacing-0 text-xs">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'data-'.e($data->id).''; ?>wire:key="data-<?php echo e($data->id); ?>"
                        class="hover:bg-slate-200 <?php echo e($data->status === 'hold' ? 'bg-red-100 hover:bg-red-200 border-l-4 border-l-red-500' : 'hover:bg-slate-50'); ?>  <?php echo e($data->status !== 'hold' && $data->hasAnyOutSpec() ? 'bg-orange-50 border-l-4 border-l-orange-400' : ''); ?>">

                        <td class="px-4 py-4 text-center text-slate-400 font-medium italic">
                            <?php echo e(($datas->currentPage() - 1) * $datas->perPage() + $loop->iteration); ?>
                        ...
                        <td
                            class="px-4 py-4 text-center font-mono text-slate-600 <?php echo e($data->isOutSpec('active_ingredient')
                                        ? 'bg-red-600 text-white border-red-700 animate-pulse'
                                        : 'text-slate-600'); ?>">
                            <?php echo e($data->active_ingredient ?? '-'); ?>
                        ...
                        <td
                            class="px-4 py-4 text-center font-mono text-slate-600 <?php echo e($data->isOutSpec('soap_percentage')
                                        ? 'bg-red-600 text-white border-red-700 animate-pulse'
                                        : 'text-slate-600'); ?>">
                            <?php echo e($data->soap_percentage ?? '-'); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\lion2\storage\framework/views/livewire/views/ddfed49f.blade.php ENDPATH**/ ?>