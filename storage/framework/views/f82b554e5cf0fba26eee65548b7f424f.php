...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Variant List']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'variant-'.e($variant->id).''; ?>wire:key="variant-<?php echo e($variant->id); ?>" class="hover:bg-slate-50 transition-colors align-middle">
                <td class="px-5 py-3 text-center text-slate-500 font-medium"><?php echo e($i + 1); ?></td>
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($variant->name); ?></span>
                </td>
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($variant->capacity); ?></span>
                </td>
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($variant->slug); ?></span>
                </td>
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($variant->category->name); ?></span>
                </td>
                <td class="px-5 py-3 text-slate-500"><?php echo e($variant->created_at->diffForHumans()); ?></td>
                <td class="px-5 py-3 text-right flex items-center">
                    <span wire:click="edit(<?php echo e($variant->id); ?>)"
...
<?php endif; ?>
                    ...
                    <span wire:click="confirm_delete(<?php echo e($variant->id); ?>)"
...
<?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\lion2\storage\framework/views/livewire/views/be6b6506.blade.php ENDPATH**/ ?>