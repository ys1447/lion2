...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Machine List']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <tr class="hover:bg-slate-50 transition-colors align-middle">
                ...
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($m->name); ?></span>
                </td>
                <td class="px-5 py-3">
                    <span class="font-medium text-slate-700"><?php echo e($m->category->name); ?></span>
                </td>
                <td class="px-5 py-3 text-slate-500"><?php echo e($m->created_at->diffForHumans()); ?></td>
                <td class="px-5 py-3 text-right flex items-center">
                    <span wire:click="edit(<?php echo e($m->id); ?>)"
...
<?php endif; ?>
                    ...
                    <span wire:click="confirm_delete(<?php echo e($m->id); ?>)"
...
<?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\lion2\storage\framework/views/livewire/views/a9d31f39.blade.php ENDPATH**/ ?>