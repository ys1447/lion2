...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <tr class="hover:bg-slate-50 transition-colors">
            ...
            <td class="px-4 py-3">
                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-2 py-0.5 rounded-sm text-[10px] font-bold uppercase' , 'bg-blue-100 text-blue-700'=> $notif->action === 'EDIT',
...
</div><?php /**PATH C:\laragon\www\lion2\storage\framework/views/livewire/views/899a6e37.blade.php ENDPATH**/ ?>